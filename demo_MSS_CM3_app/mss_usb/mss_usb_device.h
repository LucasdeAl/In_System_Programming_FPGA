...
/*=========================================================================*//**
  ...
  This driver provides a data type mss_usbd_user_class_cb_t which must be
  ...
  mss_usbd_user_class_cb_t and implement its required elements. The USBD-Class
...
/***************************************************************************//**
 mss_usbd_user_descr_cb
  ...
  The function pointed by the usb_device_descriptor element will be called when
  ...
  The function pointed by the usb_string_descriptor element will be called when
  the USB device receives from USB host the GET_DESCRIPTOR command requesting
...
typedef struct {
 ...
 mss_usb_class_cb
  ...
  usb_class_init
  The function pointed by the usb_class_init element will be called when the USB
  ...
  usb_class_deinit
  The function pointed by the usb_class_deinit element will be called when the
  ...
  The function pointed by the usb_class_process_requests element will be called
  ...
  usb_class_datain
  The function pointed by the usb_class_datain element will be called when the
  ...
  usb_class_dataout
  The function pointed by the usb_class_dataout element will be called when data
  ...
  The function pointed by the usb_class_cep_datain element will be called when
  a data packet is transmitted on the previously configured control endpoint.
  The data buffer was provided to this driver using the usb_class_process_requests
  call-back before the usb_class_cep_datain call-back was called. The parameter
  ...
  The function pointed by the usb_class_cep_dataout element will be called when
  ...
  usb_class_process_requests call-back before usb_class_cep_dataout is called.
...
/***************************************************************************//**
  @brief MSS_USBD_set_class_cb_handler()
    The MSS_USBD_set_class_cb_handler() function must be used to provide the call-back
...
/***************************************************************************//**
  @brief MSS_USBD_clr_isoupdate()
    ...
    behavior of an isochronous transmit endpoint. This function has effect only

...
/*=========================================================================*//**
  ...
  The enumeration process can take long time (hundreds of miliseconds) to
...
mss_usbh_class_cb_t
  ...
  class_id
  The class_id parameter is the placeholder for identifying the USBH-Class
...
/***************************************************************************//**
  ...
  used for the data transfer from the provided buffer to the USB FIFO. Internal
  DMA is not enabled in the USB Host mode yet.

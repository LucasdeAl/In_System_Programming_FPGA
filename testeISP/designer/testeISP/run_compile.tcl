...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Lucas\Documents\Nascerr\In_System_Programming_FPGA\testeISP\synthesis\testeISP.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\Lucas\Documents\Nascerr\In_System_Programming_FPGA\testeISP\designer\testeISP} \
    -design testeISP \
    -fam SmartFusion2 \
    -die PA4M2500 \
    -pkg vf256 \
